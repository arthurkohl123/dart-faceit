...
export const RANK_TIERS: readonly RankTier[] = [
  ...
  { level: 5, name: 'Elite',       badge: 'E5', min: 1050, color: 'text-cyan-200',    accent: 'from-cyan-400/20 to-zinc-950',    ringColor: 'border-cyan-300/40',    glowColor: 'rgba(103,232,249,0.20)' },
  { level: 6, name: 'Master',      badge: 'M6', min: 1100, color: 'text-fuchsia-200', accent: 'from-fuchsia-400/20 to-zinc-950', ringColor: 'border-fuchsia-300/40', glowColor: 'rgba(240,171,252,0.22)' },
  { level: 7, name: 'Legend',      badge: 'L7', min: 1150, color: 'text-emerald-200', accent: 'from-emerald-300/25 to-zinc-950', ringColor: 'border-emerald-300/40', glowColor: 'rgba(110,231,183,0.24)' },
] as const;
