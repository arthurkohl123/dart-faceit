-- Server-side rate-limit buckets. Keys are SHA-256 hashes generated by the app,
-- so neither IP addresses nor email addresses are stored in the database.
...
begin
  if char_length(p_key) <> 64 or p_limit < 1 or p_window_seconds < 1 then
