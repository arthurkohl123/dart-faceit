...
export function AdminOperationsWorkspace({ onNavigate }: { onNavigate: (destination: 'disputes' | 'tickets' | 'payouts' | 'tournaments' | 'flagged') => void }) {
  ...
  return <div className="space-y-6">
    ...
    <section className="overflow-hidden rounded-[2rem] border border-cyan-300/20 bg-[radial-gradient(ellipse_at_top_right,rgba(34,211,238,0.14),transparent_48%),rgba(9,13,19,0.9)] shadow-2xl shadow-black/25">
