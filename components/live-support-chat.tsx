...
export function LiveSupportChat({ conversationId, onClose }: { conversationId: string; onClose: () => void }) {
  ...
  return (
    <div className="fixed bottom-20 left-3 right-3 z-[60] flex justify-start sm:bottom-5 sm:left-5 sm:right-auto">
      <div role="dialog" aria-modal="false" aria-label="Live Support" className="flex h-[min(38rem,calc(100svh-7.5rem))] w-full max-w-md flex-col overflow-hidden rounded-[1.6rem] border border-violet-300/30 bg-[#090b12]/[0.98] shadow-[0_24px_80px_rgba(0,0,0,0.75)] backdrop-blur-2xl sm:w-[25rem]">
