...
export default function TournamentRulesPage() {
  return <LegalPageShell eyebrow="Competitive Integrity" title="Turnierregeln" intro="Ein nachvollziehbarer Rahmen für faire, kompetitive RankedDarts-Turniere.">
    <LegalSection title="1. Teilnahme"><p>Teilnehmen darf, wer ein aktives RankedDarts-Konto besitzt und die auf der Turnierkarte veröffentlichten Voraussetzungen erfüllt. Dazu können Premium-Status, maximale oder minimale AVG, Teilnehmerzahl und Anmeldeschluss gehören.</p></LegalSection>
    ...
    <LegalSection title="7. Änderungen und Entscheidungen"><p>Turnierspezifische Regeln auf der jeweiligen Turnierseite gehen diesen allgemeinen Regeln vor. Bei unvorhergesehenen Fällen trifft das Admin-Team eine faire, nachvollziehbare Entscheidung.</p></LegalSection>
  </LegalPageShell>;
}
