          ...
          <div className="relative hidden lg:block group">
            ...
            <div className="relative bg-zinc-900/40 border border-white/10 rounded-[3rem] p-2 backdrop-blur-2xl">
              <div className="bg-[#050607] rounded-[2.5rem] p-10 space-y-10">
                ...
                <Link href="/matchmaking" className="w-full py-5 bg-white/5 border border-white/10 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-white/10 transition-all flex items-center justify-center">Match Details ansehen</Link>
              </div>
            </div>
          </div>
        </div>
