    ...
    <main className="min-h-screen overflow-hidden bg-[#0a0d0d] text-[#f5f3ee]">
      ...
      <section className="relative mx-auto grid max-w-7xl gap-12 overflow-hidden px-5 pb-16 pt-14 md:px-8 lg:grid-cols-[.92fr_1.08fr] lg:items-center lg:py-24">
        ...
        <div className="relative z-10">
          ...
          <button onClick={() => router.push(isLoggedIn ? '/playtimes' : '/auth/register')} className="mt-3 inline-flex items-center gap-2 text-xs font-black text-zinc-400 transition hover:text-emerald-200"><Clock className="h-3.5 w-3.5" /> Kein Gegner gerade? Spielzeit für später planen <ChevronRight className="h-3.5 w-3.5" /></button>
