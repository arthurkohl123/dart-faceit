...
export default function PrivacyPage() {
  return <LegalPageShell eyebrow="Datenschutz" title="Datenschutzerklärung" intro="Informationen zur Verarbeitung personenbezogener Daten bei der Nutzung von RankedDarts.">
    ...
    <LegalSection title="2. Konto, Registrierung und Profil">
      <p>Bei der Registrierung und Kontonutzung verarbeiten wir E-Mail-Adresse, Nutzername, Authentifizierungs-ID, Kontostatus, Sicherheits- und Verifizierungsdaten sowie die von dir freiwillig hinterlegten Scolia- und DartCounter-Namen. Soweit die Telefonverifizierung aktiviert ist, verarbeiten wir außerdem Telefonnummer und Verifizierungsstatus. Die Verarbeitung dient der Bereitstellung des Kontos, der Missbrauchsprävention und der Nutzung der Plattform. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO; für Sicherheitsmaßnahmen zusätzlich Art. 6 Abs. 1 lit. f DSGVO.</p>
    </LegalSection>
