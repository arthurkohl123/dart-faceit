...
export default function PayoutsPage() {
  ...
  return <main className="relative min-h-screen overflow-hidden bg-[#050607] px-5 py-10 text-white sm:py-14">
    ...
    <div className="relative mx-auto max-w-4xl">
      <Link href="/account" className="inline-flex items-center gap-2 text-sm font-bold text-zinc-500 transition hover:text-white"><ChevronLeft size={17} />Konto-Zentrale</Link>
