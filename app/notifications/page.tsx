...
export default function NotificationsPage() {
  ...
  return <main className="min-h-screen bg-[#07080c] text-white"><div className="fixed inset-0 -z-10 bg-[radial-gradient(ellipse_65%_35%_at_50%_-5%,rgba(34,197,94,0.17),transparent_70%)]" />
    <nav className="mx-auto flex max-w-5xl items-center justify-between px-5 py-6 md:px-8"><Link href="/" className="inline-flex items-center gap-2 text-sm font-bold text-zinc-400 hover:text-white"><ArrowLeft size={16} /> Startseite</Link><Link href="/tournaments" className="text-sm font-bold text-emerald-200 hover:text-emerald-100">Turniere</Link></nav>
