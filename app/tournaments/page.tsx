...
export default function TournamentsPage() {
  ...
  return <main className="arena-page sport-grid overflow-x-hidden text-white">
    <nav className="arena-nav mx-auto flex max-w-7xl items-center justify-between border-b border-white/10 px-5 py-5 md:px-8">
    ...
    <section className="arena-content mx-auto px-5 pb-10 pt-12 md:px-8 md:pt-16">
    ...
    <section className="arena-content mx-auto px-5 pb-16 md:px-8">
